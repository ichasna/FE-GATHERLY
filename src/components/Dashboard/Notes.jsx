  ...
  return (
    <div className="flex w-[918px] h-[175px] p-[20px] md:p-[27px] flex-col justify-center items-start gap-[13px] flex-shrink-0 rounded-xl border border-solid border-[#404040] bg-[#1A1E23]">
      ...
      <div className="flex items-start gap-[21px]">
        <button onClick={AddNoteButton} className="hover:scale-110 duration-300">
          <img src="assets/Add-1.svg" alt="Image" className="w-68 h-62" />
        </button>
        <button onClick={Note1Button} className="hover:scale-110 duration-300 flex h-[62px] py-[12px] px-[16px] justify-center items-center gap-[6px] rounded-xl bg-[#FFF]">
          <img src="assets/Document.svg" alt="Image" className="w-26 h-26" />
